...
const ManageExtraCurricularEntitiesScreen = ({ navigation }) => {
    return (
        <View style={styles.container}>
            <Card elevation={5} style={styles.card}>
                <Card.Content>
                    {/* <Title style={styles.title}>Manage Courses</Title> */}
                    <Button
                        mode="contained"
                        // style={styles.button}
                        style={[styles.button, { backgroundColor: '#4CAF50' }]} // Change background color to green

                        onPress={() => navigation.navigate('ExistingActivities')}
                        color="#7E57C2"
                    ...
                    <Button
                        ...
                        onPress={() => navigation.navigate('NewActivityRegistration')}
                        color="#EC407A"
                        labelStyle={styles.buttonText}
                    >
...
export default ManageExtraCurricularEntitiesScreen;
