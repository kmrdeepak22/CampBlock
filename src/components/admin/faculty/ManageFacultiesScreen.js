...
const ManageFacultiesScreen = ({ navigation }) => {
    return (
            ...
            <Card elevation={5} style={styles.card}>
                <Card.Content>
                    ...
                    <Button
                        mode="contained"
                        style={styles.button}
                        onPress={() => navigation.navigate('ExistingFaculties')}
                        color="#7E57C2"
                        labelStyle={styles.buttonText}
                    >
                        View Existing Faculties
                    </Button>
                    <Button
                        mode="contained"
                        style={styles.button}
                        onPress={() => navigation.navigate('NewFacultyRegistration')}
                        color="#EC407A"
                        labelStyle={styles.buttonText}
                    >
