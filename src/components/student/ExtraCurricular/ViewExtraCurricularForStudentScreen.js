...
const ViewExtraCurricularForStudentScreen = ({ route }) => {
        ...
        <View style={styles.container}>
            <Card elevation={5} style={styles.card}>
                <Card.Content>
                    ...
                    <Button
                        ...
                        onPress={() => navigation.navigate('ViewMyActivities')}
                        // color="#7E57C2"
                    ...
                    <Button
                        ...
                        onPress={() => navigation.navigate('ViewAllActivities')}
                        color="#7E57C2"
                        labelStyle={styles.buttonText}
                    >
                        View All Activities
            ...
            <View style={styles.bottomBar}>
                ...
                <Button
                    ...
                    icon={() => (
                        <>
                            <Icon name="book" size={26} color="#4CAF50" />
...
export default ViewExtraCurricularForStudentScreen;
